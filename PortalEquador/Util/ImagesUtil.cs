...
namespace PortalEquador.Util
{
    public static class ImagesUtil
    {
        ...
        private static string GetImagePath(IWebHostEnvironment hostEnvironment, DocumentViewModel document)
        {
            ...
            string root = wwwRootPath + "/" + FoldersConstants.IMAGES + "/" + document.PersonaInformationId + "/";
        ...
        public static async Task<OperationType> CreateImage(IWebHostEnvironment hostEnvironment, DocumentViewModel document)
        {
